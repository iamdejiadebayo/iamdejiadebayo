...
```python
ai_engineering   = ["Azure OpenAI", "OpenAI API", "Anthropic Claude", "LangChain",
                     "RAG", "Prompt Engineering", "Agentic Workflows", "MCP", "Embeddings"]

ml_deep_learning = ["PyTorch", "TensorFlow", "LSTM", "CNN", "ResNet",
                     "CTC Decoding", "Attention Mechanisms", "Fine-tuning"]

software_eng     = ["Python", "JavaScript", "Java", "SQL", "REST APIs",
                     "FastAPI", "PostgreSQL", "Docker", "Azure", "CI/CD"]

product_mgmt     = ["Product Strategy", "Roadmapping", "API Design Standards",
                     "Developer Ecosystems", "Stakeholder Management", "Go-to-Market"]

consulting       = ["Market Research", "Competitive Analysis", "Business Case Development",
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/iam-de-gee)
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:adebayodeji147@gmail.com)
